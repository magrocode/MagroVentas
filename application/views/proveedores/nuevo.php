<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="span10">
			...
			<?php echo form_open('proveedores/nuevo', array('class' => 'form-horizontal', 'id' => 'formNuevo')) ?>
			  	<div class="control-group">
			    	<?php echo form_label('Rut: ', 'rut', array('class' => 'control-label', 'for' => 'rut')) ?>
			    	<div class="controls">
			      		<?php echo form_input(array('name' => 'rut', 'id' => 'rut', 'size' => '50', 'value' => set_value('rut'))) ?>
			  	...
			  	<div class="control-group">
				    ...
				    <div class="controls">
				    	<?php echo form_input(array('name' => 'nombre', 'id' => 'nombre', 'size' => '250', 'value' => set_value('nombre'))) ?>
				    </div>
			  	</div>
